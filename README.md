...
1.  **Clone the repository:**
    ...
    ```bash
    git clone https://github.com/SHAIK-RAIYAN/Pathfinder.ai.git
    cd Pathfinder.ai
    ```
...
* SHAIK RAIYAN
* Email: mail2shaikraiyan2005@gmail.com
* X : https://x.com/shaikraiyan2005
* LinkedIn : linkedin.com/in/shaik-raiyan
